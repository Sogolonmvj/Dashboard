...
import { format, SYMBOL_BRL, SYMBOL_USD } from 'helpers/currencyHelper';
...
const fetchData = async () => {
    ...
    const [priceBitcoinTrade, priceCoinbase] = 
    await Promise.all([getPriceBitcoinTrade(), getPriceCoinbase()]);
